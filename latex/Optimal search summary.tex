...
\begin{itemize}
\item Motivation
\item Underwater and surface current models for probability
\item Needed values of existing technology
\item Generalization w.r.t. search planes
\item Generalization w.r.t. fallen planes
\end{itemize}
